      ...
      <div className="container mx-auto max-w-6xl space-y-24">
        ...
        {testimonials.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, i) => (
              <motion.div
                ...
                className="group relative glass-premium p-10 rounded-[3rem] border border-border/50 bg-foreground/[0.03] hover:border-primary/20 transition-all duration-500"
              >
                <div className="flex justify-between items-start mb-8">
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h4 className="text-xl font-black text-foreground italic tracking-tighter uppercase">{testimonial.name}</h4>
                  ...
                  <div className="flex gap-1">
                    {[...Array(5)].map((_, i) => (
                      <Star 
                        ...
                        className={i < testimonial.rating ? "text-primary" : "text-foreground/10"} 
                      />
                    ))}
                  </div>
                </div>

                <p className="text-lg italic text-foreground/70 leading-relaxed font-medium">
                  "{testimonial.content}"
                </p>
          ...
          <motion.div
            ...
            className="glass border-border/50 p-16 rounded-[3rem] text-center space-y-8 relative overflow-hidden"
          >
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-bold text-foreground">Testimonials coming soon.</h2>
            ...
            <div className="flex flex-col items-center gap-4 pt-4">
              ...
              <Magnetic>
                <Link href="/testimonials/submit">
                  <button className="flex items-center gap-2 px-8 py-3 rounded-full bg-foreground/[0.03] border border-border/50 text-foreground hover:bg-foreground/[0.05] transition-all">
