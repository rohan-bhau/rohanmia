...
export default function FloatingControls() {
  ...
  return (
    ...
    <div className="floating-controls-container">
      {/* Next/Prev Buttons (Bottom Left Row) */}
      <div className="fixed bottom-6 left-6 z-40 flex gap-3 md:gap-4">
        <AnimatePresence>
          {prevRoute && (
            <motion.div
              key="prev-btn"
              ...
              <Tooltip text="Previous Page" position="top">
                <Magnetic strength={0.3}>
                  <button
                    ...
                    className="w-14 h-14 md:w-16 md:h-16 rounded-full glass-premium flex items-center justify-center text-foreground hover:bg-primary/20 hover:border-primary/50 transition-all duration-300 group shadow-lg"
                  >
      ...
      {/* Scroll to Top (Beside Chat on Bottom Right) */}
